...
from ddf.infrastructure.adapters.outbounds.extractors.comum.construir_colunas_fk import (
    construir_colunas_fk,
)
from ddf.infrastructure.adapters.outbounds.extractors.comum.construir_metadados_de_amostra import (  # noqa: E501
...
from ddf.infrastructure.adapters.outbounds.extractors.postgres._conexoes import (
    TokenDeReserva,
    _GerenciadorDeConexoesPostgres,
)
from ddf.infrastructure.adapters.outbounds.extractors.postgres._construcao import (
    _construir_coluna,
    _LinhaColuna,
    _MetadadosDoSchema,
...
from ddf.infrastructure.adapters.outbounds.extractors.postgres._queries import (
