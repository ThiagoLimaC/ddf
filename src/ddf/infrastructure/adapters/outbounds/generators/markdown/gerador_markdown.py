...
from ddf.infrastructure.adapters.outbounds.generators.markdown._filtros import (
    _colunas_com_fk_composta,
    _colunas_com_restricao_composta,
)
from ddf.infrastructure.adapters.outbounds.generators.markdown._templates import (
    _TEMPLATE_INDEX,
    _TEMPLATE_TABELA,
)
