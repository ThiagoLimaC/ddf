...
from ddf.infrastructure.adapters.outbounds.generators.comum._metricas import (
    _metrica_de_confianca,
)
from ddf.infrastructure.adapters.outbounds.generators.dbt._sql import _nome_model
