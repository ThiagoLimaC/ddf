...
from ddf.infrastructure.adapters.inbounds.cli import avisos, prompts
from ddf.infrastructure.adapters.inbounds.cli.etapas import (
    analise,
    curadoria,
    extracao,
    geracao,
...
from ddf.infrastructure.adapters.outbounds.orchestrator.orquestrador_paralelo import (
