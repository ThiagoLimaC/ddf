...
class TestFeliz:
    ...
    def test_cria_coluna_curada_com_papel_e_regras_de_negocio(
        ...
        """ColunaCurada guarda curadoria humana sobre a estrutura."""
        coluna = ColunaCurada(
            nome="email",
    ...
    def test_cria_tabela_curada_com_amostra_e_curadoria(
        ...
        """TabelaCurada guarda colunas curadas, amostra e metadados."""
        tabela = TabelaCurada(
            nome_tabela="pedidos",
            nome_escopo="public",
            colunas=[
    ...
    def test_cria_banco_curado_com_multiplas_tabelas(
        ...
        """BancoCurado agrega múltiplas TabelaCurada distintas."""
...
class TestBorda:
    ...
    def test_coluna_curada_sem_curadoria_usa_defaults_vazios(
        ...
        """Coluna recém-extraída, ainda sem curadoria, usa defaults vazios."""
    ...
    def test_tabela_curada_com_amostra_none(
        ...
        """Amostra pode ser None (mesmo DataFrame de TabelaExtraida, descartado)."""
        tabela = TabelaCurada(
            nome_tabela="pedidos",
            nome_escopo="public",
            colunas=[ColunaCurada(nome="id", tipo_dado=tipo_integer)],
