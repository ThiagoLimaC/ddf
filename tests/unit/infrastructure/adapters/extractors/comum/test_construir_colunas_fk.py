...
class TestFeliz:
    ...
    def test_monta_dict_sem_colisao_sem_avisos(
        self,
    ) -> None:
        """Cada coluna com uma única FK não gera nenhum Aviso."""
        linhas = [
...
class TestBorda:
    ...
    def test_duas_fks_na_mesma_coluna_emite_aviso_e_mantem_a_ultima(
        self,
    ) -> None:
        """Coluna com 2 FKs mantém só a última, emitindo Aviso não-fatal."""
        linhas = [
    ...
    def test_lista_de_fks_vazia_retorna_dict_e_avisos_vazios(
        self,
    ) -> None:
        """Nenhuma FK na tabela retorna dict e lista de avisos vazios."""
