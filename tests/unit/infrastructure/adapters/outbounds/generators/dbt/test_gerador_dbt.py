...
import ddf.infrastructure.adapters.outbounds.generators.dbt.gerador_dbt as gerador_dbt_modulo
...
from ddf.infrastructure.adapters.outbounds.generators.dbt.gerador_dbt import GeradorDbt
