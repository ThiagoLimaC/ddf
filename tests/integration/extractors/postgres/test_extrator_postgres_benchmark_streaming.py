...
import ddf.infrastructure.adapters.extractors.estrategias.amostragem_por_faixa as m1
import ddf.infrastructure.adapters.extractors.estrategias.percentual_de_linhas as m2
import ddf.infrastructure.adapters.extractors.postgres.extrator_postgres as m3
